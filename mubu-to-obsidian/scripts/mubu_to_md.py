#!/usr/bin/env python3
"""
将幕布导出的 HTML 转换为 Obsidian Markdown 格式（修复版）
"""
import os
import re
import sys
...
# ========== 配置 ==========
html_path = "/Users/masongqi/Documents/📑血液系统疾病.html"
...
for url in sorted(image_urls):
    match = re.search(r'(18715592_[a-f0-9-]+\.png)', url)
    if match:
...
def render_markdown(node_list, depth=0):
    """渲染为 markdown（缩进 = 4 空格/级，匹配医学笔记风格）"""
    indent = '    ' * depth
    result = []
